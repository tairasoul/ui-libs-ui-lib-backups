-- // ORIGINAL: https://github.com/RegularVynixu/Utilities/tree/main/Discord%20Inviter

-- // I've tried to make it so your Discord doesn't get prompted unless you click Join.
...
Inviter.Prompt = function(options)
  ...
  -- // Trying to make it so you don't get the prompt on Discord, unless you specifically click join.
  Prompt.Frame.Join.MouseButton1Click:Connect(function()
      	local success, inviteData = pcall(function()
